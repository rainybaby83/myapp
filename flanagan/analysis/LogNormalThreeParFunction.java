...
class LogNormalThreeParFunction implements RegressionFunction {
    ...
    public double function(double[] var1, double[] var2) {
        ...
        double var5 = var3 / ((var2[0] - var1[0]) * var1[1] * Math.sqrt(6.283185307179586D)) * Math.exp(-0.5D * Fmath.square(Math.log((var2[0] - var1[0]) / var1[2]) / var1[1]));
        return var5;
    }
