...
public class Conv {
    ...
    public static long[] convert_ArrayList_to_longs(ArrayList var0) {
        ...
        if (var0 != null) {
            ...
            for(int var3 = 0; var3 < var2; ++var3) {
                Object var4 = var0.get(var3);
                if (var4 instanceof Double) {
                    var1[var3] = Math.round((Double)var4);
                } else if (var4 instanceof Float) {
                    var1[var3] = Math.round((Float) var4);
                } else if (var4 instanceof Long) {
                    var1[var3] = (Long)var4;
                } else if (var4 instanceof Integer) {
                    var1[var3] = (long)(Integer)var4;
                } else if (var4 instanceof Short) {
                    var1[var3] = (long)(Short)var4;
                } else if (var4 instanceof Byte) {
                    var1[var3] = (long)(Byte)var4;
                } else if (var4 instanceof BigDecimal) {
        ...
        if (var0 != null) {
            ...
            for(int var3 = 0; var3 < var2; ++var3) {
                ...
                if (var4 instanceof Double) {
                    ...
                    var1[var3] = (Integer)var4;
                } else if (var4 instanceof Short) {
                    var1[var3] = (Short)var4;
                } else if (var4 instanceof Byte) {
                    var1[var3] = (Byte)var4;
                } else if (var4 instanceof BigDecimal) {
    ...
    public static long dateToJavaMilliSecondsUK(int var0, int var1, int var2, String var3, int var4, int var5, int var6, int var7) {
        TimeAndDate var8 = new TimeAndDate();
        long var9 = var8.dateToJavaMilliSecondsUK(var0, var1, var2, var3, var4, var5, var6, var7);
        return var9;
    }

    public static String decToHex() {
        long var0 = DialogueBox.readLong("Enter integer decimal number");
        String var2 = decToHex(var0);
        DialogueBox.show(var2);
        return var2;
    }
    ...
    public static long binToDec() {
        String var0 = DialogueBox.readLine("Enter binary number");
        long var1 = binToDec(var0);
        DialogueBox.show(var1);
        return var1;
    }
    ...
    public static String hexToBin() {
        String var0 = DialogueBox.readLine("Enter integer hexadecimal number");
        String var1 = hexToBin(var0);
        DialogueBox.show(var1);
        return var1;
    }
    ...
    public static long hexToDec(String var0, boolean var1) {
        ...
        for(int var5 = 0; var5 < var2; ++var5) {
            ...
            if (var6 <= 56) {
                if (var6 < 48) {
                    if (var1) {
                        DialogueBox.show(var0 + " is not an integer hexadecimal number\nMethod hexToDec aborted");
                    }

                    System.out.println(var0 + " is not an integer hexadecimal number\nMethod hexToDec aborted");
                    System.exit(0);
                } else {
                    var6 -= 48;
                }
