...
public class CubicSplineShort {
    ...
    public CubicSplineShort(double[] var1, double[] var2) {
    ...
    public CubicSplineShort(int var1) {
        this.nPoints = var1;
    ...
    public static CubicSplineShort[] oneDarray(int var0, int var1) {
        CubicSplineShort[] var2 = new CubicSplineShort[var0];
