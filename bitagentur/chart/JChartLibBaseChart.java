...
public class JChartLibBaseChart {
     ...
     * DataSet for values
     */
    private bitagentur.data.JChartLibDataSet dataSet;
     ...
     * @param dataSet data
     */
    public JChartLibBaseChart(String title, String xAxis, String yAxis, bitagentur.data.JChartLibDataSet dataSet) {
        this.title = title;
        this.xAxis = xAxis;
        this.yAxis = yAxis;
    ...
    public void setDataSet(bitagentur.data.JChartLibDataSet dataSet) {
        this.dataSet = dataSet;
    }
    ...
    public int getXDataRange() {
        List<bitagentur.data.JChartLibSerie> series = this.dataSet.getSeries();
        int range = 1;
    ...
    public boolean hasDateValues() {
        bitagentur.data.JChartLibSerie serie = getFirstSerie();
        if (serie == null) {
            return false;
        }
     ...
     * @return DataSeries
     */
    public List<bitagentur.data.JChartLibSerie> getDataSeries() {
     ...
     */
    public bitagentur.data.JChartLibSerie getFirstSerie() {
    ...
    public List<String> getSeriesNames() {
        ...
        for (bitagentur.data.JChartLibSerie serie : dataSet.getSeries()) {
