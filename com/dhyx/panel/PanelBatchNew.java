...
public class PanelBatchNew extends JPanel {
    private PanelQuery panelQuery;
    private MyIconButton btnQuery, btnBatchNew, btnSaveQRpic;

    public PanelBatchNew() {
        initSelf();
        initQueryPanel();
        initButton();
        initLabel();
        ...
        initList();
        initOther();
        clickBtnQuery("启动窗体调用，PanelBatchNew() ");
        clickTblCurve("启动窗体调用，PanelBatchNew() ");
    }
    ...
    private void initQueryPanel() {
        ...
        panelQuery.txtQuery.setToolTipText("请输入项目名称，或实验名称");
