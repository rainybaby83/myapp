...
public class PanelCurveHistory extends JPanel {
    private PanelQuery panelQuery;
    private MyIconButton btnQuery, btnUnlock;


    public PanelCurveHistory() {
        ...
        initList();
        initOther();
        clickBtnQuery("启动窗体调用，PanelCurveHistory() ");
        clickTblCurve("启动窗体调用，PanelCurveHistory() ");
    }
    ...
    private void initQueryPanel() {
        ...
        panelQuery.txtQuery.setSize(300, Const.BUTTON_HEIGHT);
