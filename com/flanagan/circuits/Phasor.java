...
public class Phasor {
    ...
    private Complex rectangular = new Complex(0.0D, 0.0D);
    private static double frequency = 0.0D / 0.0;
    private static double omega = 0.0D / 0.0;
    ...
    public static void setFrequency(double var0) {
        if (Fmath.isNaN(frequency)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for the frequency, " + frequency + ", that differs from the one you are now attempting to enter, " + var0);
        }
    }
    ...
    public static void setRadialFrequency(double var0) {
        if (Fmath.isNaN(omega)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for the radial frequency, omega, " + omega + ", that differs from the one you are now attempting to enter, " + var0);
        }
    }
    ...
    public static Phasor toPhasor(Complex var0) {
        ...
        var1.phaseInRad = var0.argRad();
        var1.phaseInDeg = var0.argDeg();
    ...
    public Complex toRectangular() {
        ...
        var1.polar(this.magnitude, this.phaseInRad);
        return var1;
    }

    public static Complex toRectangular(Phasor var0) {
        Complex var1 = new Complex();
        var1.polar(var0.magnitude, var0.phaseInRad);
        return var1;
    }
    ...
    public VectorMaths toVectorMaths() {
        double var1 = this.magnitude * Math.sin(this.phaseInRad);
        double var3 = this.magnitude * Math.cos(this.phaseInRad);
        VectorMaths var5 = new VectorMaths(var1, var3);
        return var5;
    }

    public static VectorMaths toVectorMaths(Phasor var0) {
        double var1 = var0.magnitude * Math.sin(var0.phaseInRad);
        double var3 = var0.magnitude * Math.cos(var0.phaseInRad);
        VectorMaths var5 = new VectorMaths(var1, var3);
        return var5;
    }
    ...
    public static Phasor parsePhasor(String var0) {
        ...
        var1.rectangular.polar(var1.magnitude, var1.phaseInRad);
        return var1;
    }
    ...
    public Phasor truncate(int var1) {
        if (var1 < 0) {
            ...
            var9.rectangular = Complex.truncate(var8, var1);
            return var9;
        }
    }
    ...
    public Phasor timesExpOmegaTime(double var1, double var3) {
        if (Fmath.isNaN(omega)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for the radial frequency, omega, " + omega + ", that differs from the one you are now attempting to enter, " + var1);
        }
    }
    ...
    public Phasor timesExpTwoPiFreqTime(double var1, double var3) {
        if (Fmath.isNaN(frequency)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for the frequency, " + frequency + ", that differs from the one you are now attempting to enter, " + var1);
        }
    }
    ...
    public void timesEqualsOmegaTime(double var1, double var3) {
        if (Fmath.isNaN(omega)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for radial frequency, omega, " + omega + ", that differs from the one you are now attempting to enter, " + var1);
        }
    }
    ...
    public static Phasor pow(Phasor var0, Complex var1) {
        ...
        Complex var3 = Complex.pow(var2, var1);
        Phasor var4 = toPhasor(var3);
        return var4;
    }
    ...
    public boolean isZero() {
        boolean var1 = false;
        if (Math.abs(this.magnitude) == 0.0D || this.phaseInDeg == -1.0D / 0.0) {
            var1 = true;
        }
    ...
    public boolean isPlusInfinity() {
        boolean var1 = false;
        if (this.magnitude == 1.0D / 0.0 || this.phaseInDeg == 1.0D / 0.0) {
            var1 = true;
        }
    ...
    public static Phasor plusInfinity() {
        Phasor var0 = new Phasor();
        var0.magnitude = 1.0D / 0.0;
        var0.phaseInDeg = 0.0D;
        var0.phaseInRad = 0.0D;
        var0.rectangular = new Complex(1.0D / 0.0, 1.0D / 0.0);
        return var0;
    }
    ...
    public static Phasor inductancePhasor(double var0, double var2) {
        if (Fmath.isNaN(frequency)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for the frequency, " + frequency + ", that differs from the one you are now attempting to enter, " + var2);
        }
    }
    ...
    public static Phasor finiteWarburgPhasor(double var0, double var2, double var4) {
        if (Fmath.isNaN(frequency)) {
            ...
            throw new IllegalArgumentException("You have already entered a value for the frequency, " + frequency + ", that differs from the one you are now attempting to enter, " + var4);
        }
    }
