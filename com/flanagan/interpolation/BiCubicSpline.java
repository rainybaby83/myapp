...
public class BiCubicSpline {
    ...
    public static BiCubicSpline zero(int var0, int var1) {
        if (var0 >= 3 && var1 >= 3) {
    ...
    public static BiCubicSpline[] oneDarray(int var0, int var1, int var2) {
        if (var1 >= 3 && var2 >= 3) {
            BiCubicSpline[] var3 = new BiCubicSpline[var0];
