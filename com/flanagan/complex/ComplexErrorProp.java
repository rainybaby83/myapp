...
public class ComplexErrorProp {
    ...
    public void polar(ErrorProp var1, ErrorProp var2, double var3) {
        ...
        double[][] var7 = var6.correlatedGaussianArrays(var1.getValue(), var2.getValue(), var1.getError(), var2.getError(), var3, monteCarloLength);
    ...
    public static String toString(ComplexErrorProp var0) {
        return "Real part: " + var0.eReal.getValue() + ", error = " + var0.eReal.getError() + "; Imaginary part: " + var0.eImag.getValue() + ", error = " + var0.eImag.getError();
    }
