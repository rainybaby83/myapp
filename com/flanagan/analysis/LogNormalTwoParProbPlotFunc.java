...
class LogNormalTwoParProbPlotFunc implements MinimizationFunction {
    private double[] dataArray = null;
    private double[] medians = null;
    private double[] weights = null;
    private boolean weighted = false;

    LogNormalTwoParProbPlotFunc() {
    }

    @Override
    public double function(double[] var1) {
        this.medians = Stat.logNormalOrderStatisticMedians(var1[0], var1[1], this.dataArray.length);
        double var2 = 0.0D;
