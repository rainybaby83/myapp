...
class SigmoidHillSipsFunctionDual implements RegressionFunction3 {
    ...
    public double[] function(double[] var1, double[] var2, int var3) {
        ...
        double var7 = Math.pow(var2[0], var1[1]);
        double var9 = Math.pow(var1[0], var1[1]);
        var6[0] = var4 * var7 / (var9 + var7);
        var6[1] = 0.0D;
        if (var3 >= 0) {
            var6[1] = var4 * var9 * var1[1] * Math.pow(var2[0], var1[1] - 1.0D) / ((var9 + var7) * (var9 + var7));
