...
public class Chars {
    ...
    private char[] symbolsA = new char[]{'À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Ç', '?', '?', 'È', 'É', 'Ê', 'Ë', '?', 'Ì', 'Í', 'Î', 'Ï', 'Ð', 'Ñ', 'Ò', 'Ó', 'Ô', 'Õ', 'Ö', 'Ø', 'Ù', 'Ú', 'Û', 'Ü', 'Ý', 'à', 'á', 'â', 'ã', 'ä', 'å', 'ç', '?', '?', 'è', 'é', 'ê', 'ë', '?', 'ì', 'í', 'î', 'ï', 'ð', 'ñ', 'ò', 'ó', 'ô', 'õ', 'ö', 'ø', 'ù', 'ú', 'û', 'ü', 'ý', 'ÿ', 'Š', 'š', 'Ÿ', 'ƒ'};
    private char[] replSymbolsA = new char[]{'A', 'A', 'A', 'A', 'A', 'A', 'C', 'C', 'C', 'E', 'E', 'E', 'E', 'G', 'I', 'I', 'I', 'I', 'D', 'N', 'O', 'O', 'O', 'O', 'O', 'O', 'U', 'U', 'U', 'U', 'Y', 'a', 'a', 'a', 'a', 'a', 'a', 'c', 'e', 'e', 'e', 'e', 'g', 'i', 'i', 'i', 'i', 'd', 'n', 'o', 'o', 'o', 'o', 'o', 'o', 'u', 'u', 'u', 'u', 'y', 'y', 's', 's', 'y', 'f'};
    private int[] decNumbersA = new int[]{192, 193, 194, 195, 196, 197, 199, 262, 268, 200, 201, 202, 203, 286, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 216, 217, 218, 219, 220, 221, 224, 225, 226, 227, 228, 229, 231, 232, 233, 263, 269, 234, 235, 287, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 248, 249, 250, 251, 252, 253, 255, 352, 353, 376, 402};
