...
public class Strings {
    ...
    public Strings(String var1) {
        ...
        this.htmlNamesQ = new String[]{"&quot;", "&none", "&sbquo;", "&dbquo;", "&lsaquo;", "&lsquo;", "&rsquo;", "&ldquo;", "&rdquo;", "&rsaquo;", "&laquo;", "&raquo;", "&none;", "&none;", "&none;", "&none;", "&none;", "&none;"};
        ...
        this.prepositions = new String[]{"about", "above", "across", "after", "against", "along", "among", "around", "at", "before", "behind", "below", "beneath", "beside", "between", "beyond", "but", "by", "despite", "down", "during", "except", "for", "from", "in", "inside", "into", "like", "near", "of", "off", "on", "onto", "out", "outside", "over", "past", "since", "through", "throughout", "till", "to", "toward", "under", "underneath", "until", "up", "upon", "with", "within", "without"};
        this.nPrepositions = this.prepositions.length;
        this.conjunctions = new String[]{"and", "&amp", "&", "but", "or", "nor", "for", "so", "yet", "not", "only", "also", "either", "neither", "although", "because", "since", "unless", "until", "while"};
    ...
    public String toUpperCase(int var1) {
        this.editedString = this.editedString.substring(0, var1) + this.editedString.substring(var1, var1 + 1).toUpperCase() + this.editedString.substring(var1 + 1);
        return this.editedString;
    }
    ...
    public String toLowerCase(int var1) {
        this.editedString = this.editedString.substring(0, var1) + this.editedString.substring(var1, var1 + 1).toLowerCase() + this.editedString.substring(var1 + 1);
        return this.editedString;
    }
                ...
                while(true) {
                    ...
                    if (var8 != -1) {
                        ...
                        if (var9 < this.nEdited && var8 > 0) {
                            ...
                            if (!Character.isWhitespace(var6) && (var1.charAt(var9) == 's' || var1.charAt(var9) == 'S')) {
                                ++var9;
                            }
                        }
    ...
    public int[] displayIntegers() {
        int[] var1 = new int[this.nEdited];

        for(int var2 = 0; var2 < this.nEdited; ++var2) {
            var1[var2] = this.editedString.charAt(var2);
        }
    ...
    public static int[] displayIntegers(String var0) {
        Strings var1 = new Strings(var0);
        return var1.displayIntegers();
    }
