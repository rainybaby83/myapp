...
public class DialogueBox {
    ...
    public static final synchronized double readDoubleT(String var0, String var1) {
        String var2 = "";
        double var3 = 0.0D;
        boolean var5 = false;
        System.out.flush();
        String var6 = "";
        if (inputTypeInfo) {
            var6 = "Input type: Decimal number\n\n";
        }

        while(!var5) {
            var2 = JOptionPane.showInputDialog((Component)null, var6 + var1, var0, 3);
            if (var2 != null) {
                try {
    ...
    public static final synchronized double readDouble(String var0, String var1) {
        return readDoubleT(var0, var1);
    }
    ...
    public static final synchronized double readDouble(String var0) {
        ...
        String var5 = "";
        if (inputTypeInfo) {
            var5 = "Input type: decimal number\n\n";
        }
    ...
    public static final synchronized double readDouble(String var0, double var1) {
        ...
        String var7 = "";
        if (inputTypeInfo) {
            var7 = "Input type: decimal number\n\n";
        }
    ...
    public static final synchronized double readDouble() {
        String var0 = "";
        String var1 = "Input type: decimal number";
        double var2 = 0.0D;
        boolean var4 = false;
        System.out.flush();
    ...
    public static final synchronized int readIntT(String var0, String var1) {
        String var2 = "";
        int var3 = 0;
        boolean var4 = false;
        System.out.flush();
        String var5 = "";
        if (inputTypeInfo) {
            var5 = "Input type: integer number\n\n";
        }
        ...
        while(true) {
            do {
                ...
                var2 = JOptionPane.showInputDialog((Component)null, var5 + var1, var0, 3);
            } while(var2 == null);
    ...
    public static final synchronized int readInt(String var0, String var1) {
        return readIntT(var0, var1);
    }

    private static int convertToInt(String var0) {
        int var1 = -1000;

        for(int var2 = 0; var2 < nNumbers; ++var2) {
            if (var0.trim().equalsIgnoreCase(numbersS[var2])) {
                var1 = numbersI[var2];
                break;
            }
        }
    ...
    public static final synchronized int readInt(String var0) {
        ...
        String var4 = "";
        if (inputTypeInfo) {
            var4 = "Input type: integer number\n\n";
        }
    ...
    public static final synchronized int readInt() {
        String var0 = "";
        String var1 = "Input type: integer number\n\n";
        int var2 = 0;
        boolean var3 = false;
        System.out.flush();
    ...
    public static final synchronized String readLineT(String var0, String var1) {
        String var2 = "";
        boolean var3 = false;
        String var4 = "";
        if (inputTypeInfo) {
            var4 = "Input type: a line of text\n\n";
        }

        while(!var3) {
            var2 = JOptionPane.showInputDialog((Component)null, var4 + var1, var0, 3);
    ...
    public static final synchronized String readLine(String var0) {
        ...
        String var3 = "";
        if (inputTypeInfo) {
            var3 = "Input type: a line of text\n\n";
        }
    ...
    public static final synchronized String readLine() {
        String var0 = "";
        String var1 = "Input type: a line of text\n\n";
        boolean var2 = false;
        System.out.flush();
    ...
    public static final synchronized boolean yesNo(String var0, String var1) {
        int var2 = JOptionPane.showConfirmDialog((Component)null, var1, var0, 0, 3);
        boolean var3 = false;
        if (var2 == 0) {
            var3 = true;
        }
    ...
    public static final synchronized boolean yesNo(String var0) {
        int var1 = JOptionPane.showConfirmDialog((Component)null, var0, "DialogueBox Class Yes or No Box", 0, 3);
        boolean var2 = false;
        if (var1 == 0) {
            var2 = true;
        }
    ...
    public static final synchronized boolean noYes(String var0, String var1) {
        Object[] var2 = new Object[]{"Yes", "No"};
        int var3 = JOptionPane.showOptionDialog((Component)null, var1, var0, 0, 3, (Icon)null, var2, var2[1]);
        boolean var4 = false;
        if (var3 == 0) {
            var4 = true;
        }
    ...
    public static final synchronized boolean noYes(String var0) {
        ...
        int var2 = JOptionPane.showOptionDialog((Component)null, var0, "DialogueBox Class Yes or No Box", 0, 3, (Icon)null, var1, var1[1]);
        boolean var3 = false;
        if (var2 == 0) {
            var3 = true;
        }
    ...
    public static final synchronized void show(String var0, String var1, double var2) {
        JOptionPane.showMessageDialog((Component)null, var1 + " " + var2, var0, 1);
    }

    public static final synchronized void show(String var0, double var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (double)", 1);
    }

    public static final synchronized void show(double var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (double)", 1);
    }

    public static final synchronized void show(String var0, double var1, int var3) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + Fmath.truncate(var1, var3), "DialogueBox.show (double)", 1);
    }

    public static final synchronized void show(String var0, String var1, double var2, int var4) {
        JOptionPane.showMessageDialog((Component)null, var1 + " " + Fmath.truncate(var2, var4), var0, 1);
    }

    public static final synchronized void show(double var0, int var2) {
        JOptionPane.showMessageDialog((Component)null, " " + Fmath.truncate(var0, var2), "DialogueBox.show (double)", 1);
    }
    ...
    public static final synchronized void show(String var0, float var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (float)", 1);
    }

    public static final synchronized void show(float var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (float)", 1);
    }

    public static final synchronized void show(String var0, float var1, int var2) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + Fmath.truncate(var1, var2), "DialogueBox.show (float)", 1);
    }

    public static final synchronized void show(float var0, int var1) {
        JOptionPane.showMessageDialog((Component)null, " " + Fmath.truncate(var0, var1), "DialogueBox.show (float)", 1);
    }
    ...
    public static final synchronized void show(String var0, BigDecimal var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1.toString(), "DialogueBox.show (BigDecimal)", 1);
    }

    public static final synchronized void show(BigDecimal var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0.toString(), "DialogueBox.show (BigDecimal)", 1);
    }

    public static final synchronized void show(String var0, BigInteger var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1.toString(), "DialogueBox.show (BigInteger)", 1);
    }

    public static final synchronized void show(BigInteger var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0.toString(), "DialogueBox.show (BigInteger)", 1);
    }

    public static final synchronized void show(String var0, int var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (int)", 1);
    }

    public static final synchronized void show(int var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (int)", 1);
    }
    ...
    public static final synchronized void show(String var0, long var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (long)", 1);
    }

    public static final synchronized void show(long var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (long)", 1);
    }
    ...
    public static final synchronized void show(String var0, short var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (short)", 1);
    }

    public static final synchronized void show(short var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (short)", 1);
    }
    ...
    public static final synchronized void show(String var0, byte var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (byte)", 1);
    }

    public static final synchronized void show(byte var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (byte)", 1);
    }
    ...
    public static final synchronized void show(String var0, Complex var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (Complex)", 1);
    }

    public static final synchronized void show(Complex var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (Complex)", 1);
    }

    public static final synchronized void show(String var0, Complex var1, int var2) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + Complex.truncate(var1, var2), "DialogueBox.show (Complex)", 1);
    }

    public static final synchronized void show(Complex var0, int var1) {
        JOptionPane.showMessageDialog((Component)null, " " + Complex.truncate(var0, var1), "DialogueBox.show (Complex)", 1);
    }

    public static final synchronized void show(String var0, Phasor var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (Phasor)", 1);
    }

    public static final synchronized void show(Phasor var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (Phasor)", 1);
    }

    public static final synchronized void show(String var0, Phasor var1, int var2) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + Phasor.truncate(var1, var2), "DialogueBox.show (Phasor)", 1);
    }

    public static final synchronized void show(Phasor var0, int var1) {
        JOptionPane.showMessageDialog((Component)null, " " + Phasor.truncate(var0, var1), "DialogueBox.show (Phasor)", 1);
    }

    public static final synchronized void show(String var0, ErrorProp var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (ErrorProp)", 1);
    }

    public static final synchronized void show(ErrorProp var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (ErrorProp)", 1);
    }

    public static final synchronized void show(String var0, ErrorProp var1, int var2) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + ErrorProp.truncate(var1, var2), "DialogueBox.show (ErrorProp)", 1);
    }

    public static final synchronized void show(ErrorProp var0, int var1) {
        JOptionPane.showMessageDialog((Component)null, " " + ErrorProp.truncate(var0, var1), "DialogueBox.show (ErrorProp)", 1);
    }

    public static final synchronized void show(String var0, ComplexErrorProp var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (ComplexErrorProp)", 1);
    }

    public static final synchronized void show(ComplexErrorProp var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (ComplexErrorProp)", 1);
    }

    public static final synchronized void show(String var0, ComplexErrorProp var1, int var2) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + ComplexErrorProp.truncate(var1, var2), "DialogueBox.show (ComplexErrorProp)", 1);
    }

    public static final synchronized void show(ComplexErrorProp var0, int var1) {
        JOptionPane.showMessageDialog((Component)null, " " + ComplexErrorProp.truncate(var0, var1), "DialogueBox.show (ComplexErrorProp)", 1);
    }

    public static final synchronized void show(String var0, boolean var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (boolean)", 1);
    }

    public static final synchronized void show(boolean var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (boolean)", 1);
    }
    ...
    public static final synchronized void show(String var0, char var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (char)", 1);
    }

    public static final synchronized void show(char var0) {
        JOptionPane.showMessageDialog((Component)null, " " + var0, "DialogueBox.show (char)", 1);
    }
    ...
    public static final synchronized void show(String var0, String var1, String var2) {
        JOptionPane.showMessageDialog((Component)null, var1 + " " + var2, var0, 1);
    }

    public static final synchronized void show(String var0, String var1) {
        JOptionPane.showMessageDialog((Component)null, var0 + " " + var1, "DialogueBox.show (String)", 1);
    }

    public static final synchronized void showT(String var0, String var1, String var2) {
        JOptionPane.showMessageDialog((Component)null, var1 + " " + var2, var0, 1);
    }

    public static final synchronized void show(String var0) {
        JOptionPane.showMessageDialog((Component)null, var0, "DialogueBox.show (message only)", 1);
    }
