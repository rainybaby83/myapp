...
public class FileOutput {
    ...
    public final synchronized void print(Phasor var1) {
        this.output.print(var1.toString());
    }

    public final synchronized void print(Phasor var1, int var2) {
        String var3 = "";
        var3 = var3 + var1;
        var3 = setField(var3, var2);
        this.output.print(var3);
    ...
    public final synchronized void print(ErrorProp var1) {
        this.output.print(var1.toString());
    }

    public final synchronized void print(ErrorProp var1, int var2) {
        String var3 = "";
        var3 = var3 + var1;
        var3 = setField(var3, var2);
        this.output.print(var3);
    ...
    public final synchronized void print(ComplexErrorProp var1) {
        this.output.print(var1.toString());
    }

    public final synchronized void print(ComplexErrorProp var1, int var2) {
        String var3 = "";
        var3 = var3 + var1;
        var3 = setField(var3, var2);
        this.output.print(var3);
    ...
    public final synchronized void printsp(Phasor var1) {
        this.output.print(var1.toString());
        this.output.print(" ");
    }

    public final synchronized void printsp(ErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print(" ");
    }

    public final synchronized void printsp(ComplexErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print(" ");
    }
    ...
    public final synchronized void println(Phasor var1) {
        this.output.println(var1.toString());
    }

    public final synchronized void println(ErrorProp var1) {
        this.output.println(var1.toString());
    }

    public final synchronized void println(ComplexErrorProp var1) {
        this.output.println(var1.toString());
    }
    ...
    public final synchronized void printtab(Phasor var1) {
        this.output.print(var1.toString());
        this.output.print("\t");
    }
    ...
    public final synchronized void printtab(Phasor var1, int var2) {
        String var3 = "";
        var3 = var3 + var1;
        var3 = setField(var3, var2);
        this.output.print(var3);
    ...
    public final synchronized void printtab(ErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print("\t");
    }

    public final synchronized void printtab(ErrorProp var1, int var2) {
        String var3 = "";
        var3 = var3 + var1;
        var3 = setField(var3, var2);
        this.output.print(var3);
    ...
    public final synchronized void printtab(ComplexErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print("\t");
    }

    public final synchronized void printtab(ComplexErrorProp var1, int var2) {
        String var3 = "";
        var3 = var3 + var1;
        var3 = setField(var3, var2);
        this.output.print(var3);
    ...
    public final synchronized void printcomma(Phasor var1) {
        this.output.print(var1.toString());
        this.output.print(",");
    }

    public final synchronized void printcomma(ErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print(",");
    }

    public final synchronized void printcomma(ComplexErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print(",");
    }
    ...
    public final synchronized void printsc(Phasor var1) {
        this.output.print(var1.toString());
        this.output.print(";");
    }

    public final synchronized void printsc(ErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print(";");
    }

    public final synchronized void printsc(ComplexErrorProp var1) {
        this.output.print(var1.toString());
        this.output.print(";");
    }
    ...
    public static void printArrayToText(Phasor[][] var0) {
        String var1 = "ArrayToText.txt";
        printArrayToText(var1, var0);
    }

    public static void printArrayToText(String var0, Phasor[][] var1) {
        FileOutput var2 = new FileOutput(var0, 'n');
        var2.dateAndTimeln(var0);
        int var3 = var1.length;
        boolean var4 = false;
    ...
    public static void printArrayToText(ErrorProp[][] var0) {
        String var1 = "ArrayToText.txt";
        printArrayToText(var1, var0);
    }

    public static void printArrayToText(String var0, ErrorProp[][] var1) {
        FileOutput var2 = new FileOutput(var0, 'n');
        var2.dateAndTimeln(var0);
        int var3 = var1.length;
        boolean var4 = false;
    ...
    public static void printArrayToText(ComplexErrorProp[][] var0) {
        String var1 = "ArrayToText.txt";
        printArrayToText(var1, var0);
    }

    public static void printArrayToText(String var0, ComplexErrorProp[][] var1) {
        FileOutput var2 = new FileOutput(var0, 'n');
        var2.dateAndTimeln(var0);
        int var3 = var1.length;
        boolean var4 = false;
    ...
    public static boolean deleteFile(String var0) {
        ...
        if (var2.isDirectory()) {
            ...
            if (var3.length > 0) {
                System.out.println("Method deleteFile: " + var0 + " is a directory which is not empty; no action was taken");
                var1 = false;
            }
        }
    ...
    public static int renameFile(String var0, String var1) {
        ...
        if (!var4.exists()) {
            ...
            if (!var2) {
                System.out.println("Class FileInput: method renameFile failed to rename the file " + var0 + " to " + var1);
                return 3;
            } else {
                return var3;
            }
